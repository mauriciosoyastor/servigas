...
const LISTS: Record<RecordListKey, RecordListDef> = {
  "inventory/products": {
    ...
    title: "Productos",
    hint: "Plantillas almacenables activas",
    model: "product.template",
    domain: [["active", "=", true]],
    fields: ["name", "default_code", "list_price", "qty_available", "active"],
  ...
  "inventory/variants": {
    ...
    title: "Variantes SKU",
    hint: "Referencias de inventario",
    ...
    railApp: "inventory",
    imageField: "image_128",
    searchFields: ["name", "default_code", "display_name"],
  ...
  "inventory/no-stock": {
    ...
    title: "Sin stock",
    hint: "Productos almacenables en cero",
    model: "product.product",
    domain: [
      ["is_storable", "=", true],
      ["qty_available", "<=", 0],
    ],
    fields: ["display_name", "default_code", "qty_available", "active"],
    columns: productCols("display_name"),
    limit: 50,
    order: "default_code asc",
    hubBack: "/hubs/inventory",
  ...
  "inventory/no-price": {
    ...
    hint: "Plantillas con list_price en cero",
    model: "product.template",
    domain: [["list_price", "=", 0]],
